...
Public Class rpt_factura_ticket
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PagoNet.Reports.rpt_factura_ticket.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_factura_ticket
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_factura_ticket = New rpt_factura_ticket()
        rpt.Site = Me.Site
        Return rpt
    End Function
